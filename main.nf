...
========================================================================================
                         nf-core/outlaw
========================================================================================
 nf-core/outlaw Analysis Pipeline.
 #### Homepage / Documentation
 https://github.com/nf-core/outlaw
----------------------------------------------------------------------------------------
*/
...
def helpMessage() {
    ...
    =======================================================
     ...
     nf-core/outlaw v${workflow.manifest.version}
    =======================================================
...
======================================================="""
def summary = [:]
summary['Pipeline Name']    = 'nf-core/outlaw'
...
def create_workflow_summary(summary) {
    ...
    yaml_file.text  = """
    id: 'nf-core-outlaw-summary'
    description: " - this information is collected when the pipeline is started."
    section_name: 'nf-core/outlaw Workflow Summary'
    section_href: 'https://github.com/nf-core/outlaw'
    plot_type: 'html'
    data: |
...
workflow.onComplete {
    ...
    def subject = "[nf-core/outlaw] Successful: $workflow.runName"
    if(!workflow.success){
      subject = "[nf-core/outlaw] FAILED: $workflow.runName"
    }
    def email_fields = [:]
    ...
    if (params.email) {
        try {
          ...
          log.info "[nf-core/outlaw] Sent summary e-mail to $params.email (sendmail)"
        } catch (all) {
          // Catch failures and try with plaintext
          [ 'mail', '-s', subject, params.email ].execute() << email_txt
          log.info "[nf-core/outlaw] Sent summary e-mail to $params.email (mail)"
        }
    }
    ...
    log.info "[nf-core/outlaw] Pipeline Complete"
